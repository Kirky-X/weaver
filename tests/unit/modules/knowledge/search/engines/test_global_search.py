...
class TestGlobalSearchEngineBasic:
    ...
    @pytest.mark.asyncio
    async def test_global_search_with_hybrid_engine(self, mock_context_builder, mock_llm):
...
class TestGlobalSearchEngineSearch:
    ...
    @pytest.mark.asyncio
    async def test_search_handles_error(self, mock_context_builder, mock_llm):
...
class TestGlobalSearchEngineGetCommunityContexts:
    ...
    @pytest.mark.asyncio
    async def test_get_community_contexts_returns_empty(self, mock_context_builder, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_get_community_contexts_returns_contexts(self, mock_context_builder, mock_llm):
...
class TestGlobalSearchEngineSimple:
    ...
    @pytest.mark.asyncio
    async def test_search_simple_without_llm(self, mock_context_builder, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_search_simple_with_llm(self, mock_context_builder, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_search_simple_handles_llm_error(self, mock_context_builder, mock_llm):
...
class TestGlobalSearchEngineSimpleConfidence:
    ...
    def test_estimate_simple_confidence_empty_sections(self, mock_context_builder, mock_llm):
    ...
    def test_estimate_simple_confidence_with_communities(self, mock_context_builder, mock_llm):
    ...
    def test_estimate_simple_confidence_one_community(self, mock_context_builder, mock_llm):
