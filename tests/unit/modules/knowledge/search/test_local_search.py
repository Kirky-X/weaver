...
class TestLocalSearchEngineEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_local_search_with_no_entities(self, mock_context_builder, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_local_search_with_entity_names(self, mock_context_builder, mock_llm):
    ...
    @pytest.mark.asyncio
    async def test_local_search_respects_token_limit(self, mock_context_builder, mock_llm):
