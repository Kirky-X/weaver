...
class TestSplitContract:
    ...
    def test_facade_public_surface_unchanged(self):
        ...
        expected = {
            "get", "get_by_id", "get_by_ids", "get_existing_urls", "get_existing_titles",
            "get_pending", "get_pending_neo4j", "get_stuck_articles", "get_all_article_ids",
            "get_incomplete_articles", "get_failed_articles", "fetch_titles_by_pg_ids",
            "fetch_bodies_by_pg_ids", "get_task_progress_stats", "search_by_text",
            "detect_merge_cycle", "resolve_final_merge_target",
            "bulk_upsert", "upsert", "update_persist_status", "mark_terminal_by_url",
            "update_credibility", "requeue_processing", "revert_to_pg_done",
            "update_enrichment_if_null", "update_processing_stage",
            "bulk_update_processing_stage", "mark_failed", "mark_processing",
            "revert_to_stored", "deduplicate_articles",
            "insert_raw", "bulk_insert_raw",
        }
